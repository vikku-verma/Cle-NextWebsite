                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="w-6 h-6 rounded-full bg-amber-500 flex items-center justify-center text-white text-xs font-bold">
                                            {workshop.mentorName?.charAt(0)?.toUpperCase() || 'G'}
                                        </div>
                                    ...
                                    <div>
                                        <Link
                                            ...
                                            className="inline-flex items-center gap-2 px-4 py-2 bg-[#0f172a] text-white text-xs font-black uppercase tracking-wider rounded-lg hover:bg-[#92400e] transition-all"
                                        >
                                            View Details
                                            <ChevronRight className="w-3 h-3" />
                                        </Link>
