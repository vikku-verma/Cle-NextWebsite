...
// Separate Server Component for fetching and displaying the grid
...
export default async function BlogPage({
    ...
    // Fetch filters statically for the page shell
    ...
    // Generate a unique key based on search params so Suspense re-triggers on pagination
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            {/* Blog Grid Content - Wrapped in Suspense */}
            <Suspense key={suspenseKey} fallback={<section className="container py-16 px-4 md:px-6"><BlogGridSkeleton /></section>}>
