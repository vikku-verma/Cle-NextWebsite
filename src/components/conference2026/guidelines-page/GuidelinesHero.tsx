        ...
        <section className="relative pt-32 pb-20 overflow-hidden bg-[#0F1115]">
            ...
            <div className="container px-4 md:px-6 relative z-10">
                <div className="max-w-4xl mx-auto text-center space-y-6 flex flex-col items-center justify-center">
                    <ConferenceBreadcrumb pageName="Guidelines" />
                    ...
                    >
                        Conference <span className="text-primary italic font-normal">Guidelines</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Essential information for participants to ensure a smooth and beneficial online conference experience.
                    </motion.p>
                </div>
            </div>
